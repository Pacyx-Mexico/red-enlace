...
import PagoAutos from "./Inputs/PagoAutos";
import "../../../styles/forms/Gm/Step4GM.css";

class Step6Autos extends Component {
  state = {
    ...
    return (
      <section>
        ...
        <PagoAutos
          ...
          validationONStep4={this.validationONStep6}
