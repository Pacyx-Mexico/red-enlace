    ...
    <PartnersSection>
      <div className="container d-none d-lg-block">
        ...
        <div className="d-flex justify-content-between align-items-center mt-5 pt-5">
          <img src="https://elementos-red-enlace.s3.amazonaws.com/Landing/logoGapper.png" alt="" className="w-auto h-50"/>
          ...
          <img src="https://elementos-red-enlace.s3.amazonaws.com/Landing/logo-securus.png" alt="" className="w-auto h-50"/>
        </div>
      </div>
      ...
      <div className="container d-lg-none">
        ...
        <div className="mx-auto d-flex justify-content-around align-items-center mt-5 pt-5 h-25">
          <img src="https://elementos-red-enlace.s3.amazonaws.com/Landing/logoGapper.png" alt="" className="socios-img_size_mb"/>
          ...
          <img src="https://elementos-red-enlace.s3.amazonaws.com/Landing/logo-securus.png" alt="" className="socios-img_size_mb"/>
        </div>
      </div>
    </PartnersSection>
  )
